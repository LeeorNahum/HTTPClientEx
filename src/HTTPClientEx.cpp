 ...
 * @return success bool
 */
bool HTTPClientEx::begin(WiFiClient &client, String url) {
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
 ...
 * @return success bool
 */
bool HTTPClientEx::begin(WiFiClient &client, String host, uint16_t port, String uri, bool https)
{
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool HTTPClientEx::begin(String url, const char* CAcert)
{
 ...
 * @param url String
 */
bool HTTPClientEx::begin(String url)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClientEx::beginInternal(String url, const char* expectedProtocol)
{
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool HTTPClientEx::begin(String host, uint16_t port, String uri)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClientEx::begin(String host, uint16_t port, String uri, const char* CAcert)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HTTPClientEx::begin(String host, uint16_t port, String uri, const char* CAcert, const char* cli_cert, const char* cli_key)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
 ...
 */
void HTTPClientEx::disconnect(bool preserveClient)
{
    if(connected()) {
 ...
 * @param reuse bool
 */
void HTTPClientEx::setReuse(bool reuse)
{
    _reuse = reuse;
}
 ...
 */
void HTTPClientEx::setUserAgent(const String& userAgent)
{
 ...
 */
void HTTPClientEx::setAuthorization(const char * user, const char * password)
{
    if(user && password) {
        String auth = user;
        auth += ":";
 ...
 */
void HTTPClientEx::setAuthorization(const char * auth)
{
    if(auth) {
 ...
 */
void HTTPClientEx::setAuthorizationType(const char * authType)
{
    if(authType) {
 ...
 */
void HTTPClientEx::setConnectTimeout(int32_t connectTimeout)
{
 ...
 */
void HTTPClientEx::setTimeout(uint32_t timeout)
{
    _tcpTimeout = timeout;
    if(connected()) {
 ...
 * @param use
 */
void HTTPClientEx::useHTTP10(bool useHTTP10)
{
 ...
 * @return http code
 */
int HTTPClientEx::POST(uint8_t * payload, size_t size)
{
    return sendRequest("POST", payload, size);
}

int HTTPClientEx::POST(String payload)
{
 ...
 * @return http code
 */
int HTTPClientEx::PATCH(uint8_t * payload, size_t size)
{
    return sendRequest("PATCH", payload, size);
}

int HTTPClientEx::PATCH(String payload)
{
 ...
 * @return http code
 */
int HTTPClientEx::PUT(uint8_t * payload, size_t size) {
    return sendRequest("PUT", payload, size);
}

int HTTPClientEx::PUT(String payload) {
 ...
 * @return
 */
int HTTPClientEx::sendRequest(const char * type, String payload)
{
 ...
 */
int HTTPClientEx::sendRequest(const char * type, uint8_t * payload, size_t size)
{
    int code;
    bool redirect = false;
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HTTPClientEx::sendRequest(const char * type, Stream * stream, size_t size)
{
 ...
 * @return WiFiClient
 */
WiFiClient& HTTPClientEx::getStream(void)
{
    if (connected()) {
        return *_client;
    }
 ...
 * @return WiFiClient*
 */
WiFiClient* HTTPClientEx::getStreamPtr(void)
{
    if(connected()) {
        return _client;
    }
 ...
 */
int HTTPClientEx::writeToStream(Stream * stream)
{
 ...
 * @return String
 */
String HTTPClientEx::getString(void)
{
 ...
 * @param first
 */
void HTTPClientEx::addHeader(const String& name, const String& value, bool first, bool replace)
{
...
void HTTPClientEx::collectHeaders(const char* headerKeys[], const size_t headerKeysCount)
{
...
String HTTPClientEx::header(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
...
String HTTPClientEx::header(size_t i)
{
...
String HTTPClientEx::headerName(size_t i)
{
    if(i < _headerKeysCount) {
...
int HTTPClientEx::headers()
{
    return _headerKeysCount;
}

bool HTTPClientEx::hasHeader(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
 ...
 */
bool HTTPClientEx::connect(void)
{
    if(connected()) {
        if(_reuse) {
    ...
    if (!_client) {
        log_d("HTTPClientEx::begin was not called or returned error");
        return false;
    }
#ifdef HTTPCLIENT_1_1_COMPATIBLE
 ...
 * @return status
 */
bool HTTPClientEx::sendHeader(const char * type)
{
    if(!connected()) {
        return false;
    }
 ...
 */
int HTTPClientEx::handleHeaderResponse()
{
 ...
 */
int HTTPClientEx::writeToStreamDataBlock(Stream * stream, int size)
{
    int buff_size = HTTP_TCP_BUFFER_SIZE;
    int len = size;
    int bytesWritten = 0;
 ...
 * @return error
 */
int HTTPClientEx::returnError(int error)
{
    if(error < 0) {
...
void HTTPClientEx::setFollowRedirects(followRedirects_t follow)
{
    _followRedirects = follow;
}

void HTTPClientEx::setRedirectLimit(uint16_t limit)
{
 ...
 * @param url
 */
bool HTTPClientEx::setURL(const String& url)
{
...
const String &HTTPClientEx::getLocation(void)
{
    return _location;
}

void HTTPClientEx::setCookieJar(CookieJar* cookieJar)
{
    _cookieJar = cookieJar;
}

void HTTPClientEx::resetCookieJar()
{
    _cookieJar = nullptr;
}

void HTTPClientEx::clearAllCookies()
{
    if (_cookieJar) _cookieJar->clear();
}

void HTTPClientEx::setCookie(String date, String headerValue)
{
    if (!_cookieJar)
    {
        return;
...
bool HTTPClientEx::generateCookieString(String *cookieString)
{
    time_t now_local = time(NULL);
    time_t now_gmt = mktime(gmtime(&now_local));
